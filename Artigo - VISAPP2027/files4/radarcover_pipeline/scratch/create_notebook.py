...
# Fix cell 18 string template formatting
for cell in cells:
    if cell["cell_type"] == "code":
        src = "".join(cell["source"])
        if "problem.coverage_req[ui] assignment" in src:
            src = src.replace("problem.coverage_req[ui] assignment if False else problem.coverage_req[ui] assignment if False else problem.coverage_req[ui]", "problem.coverage_req[ui]")
            cell["source"] = [src]
